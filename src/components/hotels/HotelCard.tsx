...
import { Wifi, Dumbbell, Car, Waves, Utensils, Sparkles, MapPin, Star } from "lucide-react";
...
const amenityConfig: Record<string, { icon: React.ReactNode; label: string }> = {
  ...
  restaurant:      { icon: <Utensils className="w-3.5 h-3.5" />,  label: "Restaurant" },
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        ...
        <div className="flex items-center gap-2">
          <span className={cn("text-xs font-bold px-2 py-0.5 rounded-md", ratingColor(hotel.rating))}>
        ...
        <div className="flex items-end justify-between pt-3 border-t border-neutral-100 dark:border-neutral-800">
          <div>
            <div className="text-[10px] text-neutral-400 uppercase tracking-wide mb-0.5">From</div>
