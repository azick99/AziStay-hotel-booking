...
export default function SearchResultsPage() {
  ...
  return (
    <div className="min-h-screen  bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="sticky top-20 z-40 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="bg-neutral-50 dark:bg-neutral-800/60 rounded-2xl border border-neutral-200 dark:border-neutral-700 px-5 py-4">
            <SearchBar />
          </div>
        </div>
      </div>
